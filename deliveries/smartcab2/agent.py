...
class LearningAgent(Agent):
    ...
    def __init__(self, env, learning=False, epsilon=1.0, alpha=0.5, verbose=False):
...
def run():
    ...
    update_delay = 0.01
    #update_delay = 2.0
    sim = Simulator(env, update_delay=update_delay, log_metrics=True, display=False, optimized=True)
